...
dataset = "Binaryville_semantic" # Enter the name or ID of the semantic model
workspace = "BinaryVille - Retail Analytics" # Enter the workspace name or ID in which the semantic model exists
